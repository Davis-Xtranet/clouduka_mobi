                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(5.0),
                                image: DecorationImage(image: NetworkImage("https://imaginelighting.clouduka.co.ke/uploads/7/21/06/210621162425788660d0355ea6385.webp"))
                            ),
                            child: Container(),
                          ),
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text("Africa Gold", style: TextStyle(color: darkText, fontSize: 12),)),
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text("Ksh 1000", style: TextStyle(color: mainThemeColor, fontSize: 12),)),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text("Cushion Convers", style: TextStyle(color: darkText, fontSize: 12),)),
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text("Ksh 200", style: TextStyle(color: mainThemeColor, fontSize: 12),)),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text("Lacey MAson", style: TextStyle(color: darkText, fontSize: 12),)),
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text("Ksh 22000", style: TextStyle(color: mainThemeColor, fontSize: 12),)),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text("Greenvil Lights", style: TextStyle(color: darkText, fontSize: 12),)),
                          Align(
                              alignment: Alignment.centerLeft,
                              child: Text("Ksh 12000", style: TextStyle(color: mainThemeColor, fontSize: 12),)),
